...
import type { DeleteProjectUseCase } from '../../project/application/delete-project-usecase';
...
import type { RenameProjectUseCase } from '../../project/application/rename-project-usecase';
...
interface AppDeps {
  ...
  readonly project: {
    ...
    readonly renameProject: RenameProjectUseCase;
